    ...
    if (filaVisual != -1) {
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            try {
                ...
                Modelo.Final.TransportistasDAO dao = new Modelo.Final.TransportistasDAO();
...
try {
    ...
    Controlador.Final.clsTransportistas transportista =
            new Controlador.Final.clsTransportistas();
    ...
    Modelo.Final.TransportistasDAO dao =
            new Modelo.Final.TransportistasDAO();
...
try {
    ...
    Controlador.Final.clsTransportistas obj =
            new Controlador.Final.clsTransportistas();
   ...
   public void actualizarTabla() {
    Modelo.Final.TransportistasDAO transporteDAO = new Modelo.Final.TransportistasDAO();
    List<Controlador.Final.clsTransportistas> lista = transporteDAO.listar();

    modeloTransportes.setRowCount(0); 

    for (Controlador.Final.clsTransportistas t : lista) {
